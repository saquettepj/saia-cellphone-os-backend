...
function generateEmailResetPasswordObject(
  token: string,
  newPassword: string,
): IEmailMessageConfig {
  const resetPasswordUrl = `${env.FRONTEND_URL}/generic-list?token=${token}`
                                                            ...
                                                            <tbody>
                                                              <tr style="border-collapse:collapse">
                                                                  <td align="center" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px">
                                                                    ...
                                                                    <h2 class="m_-4676932673795261361es-m-txt-c" 
                                                                        style="Margin:0;font-family:-apple-system,blinkmacsystemfont,'segoe ui',roboto,helvetica,arial,sans-serif,'apple color emoji','segoe ui emoji','segoe ui symbol';letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:28.8px;color:#333333">
                                                                        <b>
                                                                            ${newPassword}
                                                                        </b>
                                                                    </h2>
...
export { generateEmailResetPasswordObject }
