  ...
  try {
    ...
    const responseBody: IGetCompanyByIdControllerResponse = {
      company: {
        ...
        employees: getCompanyByIdUseCaseReturn.employees || null,
        clients: getCompanyByIdUseCaseReturn.clients || null,
        products: getCompanyByIdUseCaseReturn.products || null,
        orders: getCompanyByIdUseCaseReturn.orders || null,
        Nfes: getCompanyByIdUseCaseReturn.Nfes || null,
      },
    }
